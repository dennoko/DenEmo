...
public static class DenEmoLoc
{
    ...
    ["ui.symmetry.tip"] = "末尾がL/Rのシェイプを1行にまとめ、左右を同時に編集します。",
        ...
        ["ui.fx.set.default.tip"]        = "メニューのデフォルト値",
        ["ui.fx.set.filter.tip"]         = "表情セットの切替パラメーター「{0}」で絞り込み",
        ["ui.fx.slot.none"]              = "未指定 ▾",
    ...
    ["ui.symmetry.tip"] = "Merge L/R-suffixed shapes into one row and edit both sides together.",
        ...
        ["ui.fx.set.default.tip"]        = "Menu default value",
        ["ui.fx.set.filter.tip"]         = "Filter by expression-set parameter \"{0}\"",
