...
public static class DenEmoLoc
{
    ...
    ["ui.symmetry.tip"] = "末尾がL/Rのシェイプを1行にまとめ、左右を同時に編集します。",
        ...
        ["ui.fx.mode.direct.desc"]       = "⚠ 既存のコントローラーを直接書き換えます（自動バックアップを作成します）。",
        ...
        ["ui.fx.confirm.direct.head"]    = "既存の FX コントローラーを直接変更します（自動バックアップあり）。",
    ...
    ["ui.symmetry.tip"] = "Merge L/R-suffixed shapes into one row and edit both sides together.",
        ...
        ["ui.fx.mode.direct.desc"]       = "⚠ Modifies the existing controller directly (an automatic backup is created).",
        ...
        ["ui.fx.confirm.direct.head"]    = "The existing FX controller will be modified directly (with automatic backup).",
